...
{
echo "<img src=".$filepath." height=200 width=200 style='left: 50%;z-index: 1;height: 150px;width: 150px;position: absolute;border-radius: 50%;top: 10%;' />";
...
<div class="form">
<p><a Logout</a></p>
<form action="register_member.php" enctype="multipart/form-data" method="post">
Select image :
...
<p><input type="text" name="age" placeholder="Enter Employer ID" required /></p>
